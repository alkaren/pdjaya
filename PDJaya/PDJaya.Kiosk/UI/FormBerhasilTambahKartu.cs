...
{
    public partial class FormBerhasilTambahKartu : Form
    {
        ...
        public FormBerhasilTambahKartu(string CardID)
        {
            ActiveFormInfo();
            InitializeComponent();
            this.CardID = CardID;
        ...
        void Configure()
        {
            ...
            picBox.Image = Properties.Resources.layar_kartu_add_ok;
        ...
        void ResizeComponent(double newWidth, double newHeight)
        {
            ...
            LblCardID.Height = Convert.ToInt32(100 * ratioH);
        }
    }
}
